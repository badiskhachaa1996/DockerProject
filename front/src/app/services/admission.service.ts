...
export class AdmissionService {
  ...
  create(tbObj: any) {
    ...
    return this.httpClient.post<any>(registerUrl, tbObj, httpOptions);
  }

  //Modification d'un prospect
  update(tbObj: any) {
    let registreUrl = this.apiUrl + 'update';
    return this.httpClient.put<any>(registreUrl, tbObj, httpOptions1);
  }
  ...
  ValidateEmail(email) {
    ...
    return this.httpClient.get<any>(registreurl,httpOptions);
  }
  ...
  getAll() {
    ...
    return this.httpClient.get<Prospect[]>(registreUrl, httpOptions1);
  }

  updateStatut(id_prospect, p) {
    let url = this.apiUrl + "updateStatut/" + id_prospect
    return this.httpClient.post<Prospect>(url, p, httpOptions1);
  }
