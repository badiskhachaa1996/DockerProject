...
export class TicketService {
  ...
  create(ticket){
    ...
    return this.http.post<any>(registreUrl,ticket,this.httpOptions1);
  }
  ...
  setAccAff(info:any){
    ...
    return this.http.post<any>(registreUrl,info,this.httpOptions1);
  }
  ...
  getCountWaiting()
  {
    ...
    return this.http.get<Ticket[]>(registreUrl, this.httpOptions1);
  }
