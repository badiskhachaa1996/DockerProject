...
export class AddCampusComponent implements OnInit {
  ...
  addcampusForm: UntypedFormGroup = new UntypedFormGroup({
    ...
    email: new UntypedFormControl('', [Validators.required, Validators.email, Validators.pattern("^[a-z0-9._%+-]+((@estya+\.com)|(@estyagroup+\.com)|(@elitech+\.education)|(@eduhorizons+\.com)|(@adgeducation+\.com))$")]),
