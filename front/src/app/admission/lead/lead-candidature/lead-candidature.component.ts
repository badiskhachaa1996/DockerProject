...
export class LeadCandidatureComponent implements OnInit {
  ...
  formCandidature = new UntypedFormGroup({
    ...
    lead_id: new UntypedFormControl(''),
    isPMR: new UntypedFormControl(false),
    PMRneedHelp: new UntypedFormControl(false),
    qualites: new UntypedFormControl(''),
    toWorkOn: new UntypedFormControl(''),
    skills: new UntypedFormControl(''),
    parcours: new UntypedFormControl(''),
    experiences: new UntypedFormControl(''),
    courtterme3: new UntypedFormControl(''),
    courtterme5: new UntypedFormControl(''),
    courtterme10: new UntypedFormControl(''),
    formation: new UntypedFormControl(''),
    campus: new UntypedFormControl(''),
    rentrée_scolaire: new UntypedFormControl(''),
    niveau: new UntypedFormControl("Intermédiaire"),
    suivicours: new UntypedFormControl(false),
    acceptRythme: new UntypedFormControl(false),
    besoins: new UntypedFormControl(''),
    motivations: new UntypedFormControl(2),
    attentes: new UntypedFormControl(''),
    niveau_actuel: new UntypedFormControl(2),
    competences_digitales: new UntypedFormControl(2),
    competences_teams: new UntypedFormControl(2),
    competences_solo: new UntypedFormControl(2),
  })
