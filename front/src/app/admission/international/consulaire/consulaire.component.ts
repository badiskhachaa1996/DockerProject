...
export class ConsulaireComponent implements OnInit {
  ...
  constructor(private PartenaireService: PartenaireService, private messageService: MessageService, private admissionService: AdmissionService,
    ...
    private UserService: AuthService, private EmailTypeS: EmailTypeService, private VenteService: VenteService, private NotifService: NotificationService, private EmailService: EmailTypeService, private Socket: SocketService) { }
  ...
  initTraitement(prospect: Prospect) {
    ...
    this.traitementForm.patchValue({ consulaire_date: this.convertTime(prospect.consulaire_date) })
  ...
  traitementForm: UntypedFormGroup = new UntypedFormGroup({
    ...
    consulaire_date: new UntypedFormControl(''),
    ...
    note_consulaire: new UntypedFormControl(""),
    consulaire_traited_by: new UntypedFormControl(null),
