...
export class AddSeanceComponent implements OnInit {
  ...
  saveSeance() {
    ...
    let seance = new Seance(null, classeList, this.seanceForm.value.matiere.value, libelle, this.seanceForm.value.date_debut, this.seanceForm.value.date_fin, formateur, info,
      this.seanceForm.value.isPresentiel, salle_name, this.seanceForm.value.isPlanified.value, this.seanceForm.value.campus_id, this.seanceForm.value.nbseance, null, this.seanceForm.value.libelle, this.seanceForm.value.seance_type, this.seanceForm.value.time_max_sign, this.seanceForm.value.forcedAllowedByFormateur, this.seanceForm.value.isOptionnel);
    let choice = true
    ...
    if (!this.seanceForm.get('isUnique').value) {
      ...
      while (date_de_debut <= dateFinPlan) {
        ...
        let seance = new Seance(null, classeList, this.seanceForm.value.matiere.value, this.seanceForm.value.libelle, newDateDebut, newDateFin, formateur, info,
          this.seanceForm.value.isPresentiel, salle_name, this.seanceForm.value.isPlanified.value, this.seanceForm.value.campus_id, newNumeroSeance, null, this.seanceForm.value.libelle, this.seanceForm.value.seance_type, this.seanceForm.value.time_max_sign, this.seanceForm.value.forcedAllowedByFormateur, this.seanceForm.value.isOptionnel);
