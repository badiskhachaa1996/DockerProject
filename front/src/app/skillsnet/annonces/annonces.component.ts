...
export class AnnoncesComponent implements OnInit {
  ...
  chargeCompetence(event)
  {
    ...
    switch(label){
      ...
      case 'Office Manager':
        this.competencesList = [
          { label: "Tu aimes les thématiques bien-être" },
          { label: "Tu pratiques quelques thérapies (hypnose, énergéticien, massages thérapeutiques, magnétiseurs, psychologue, coach)" },
