...
export const environment = {
    recaptchaKey: '6LeINi0pAAAAAF_WQ7EZaQ9RdYoZZ5Rn4XLuDUe7',
    origin: "https://dev-forms.intedgroup.com/soc/",
    ...
    formations: [
        ...
        {value: "RNCP Développeur",
            label: "RNCP Développeur"},
        {value: "RNCP AIS",
            label: "RNCP AIS"},
        {value: "MPI Big Data",
            label: "MPI Big Data"},
        {value: "MPI CyberSecurité",
            label: "MPI CyberSecurité"},
        {value: "RNCP ARH",
            label: "RNCP ARH"},
        {value: "BTS Assurance",
            label: "BTS Assurance"},
        ...
        {value: "BTS Hôtellerie-Restauration",
            label: "BTS Hôtellerie-Restauration"},
        {value: "BTS SPSSS",
            label: "BTS SPSSS"},
        {value: "RNCP RET",
            label: "RNCP RET"},
    ...
    modalite_paiement: [
        {
            value: "Paiement par chèque",
            label: "Paiement par chèque"
        },
        {
            value: "Paiement par virement",
            label: "Paiement par virement"
        },
        {value: "Paiement par prélèvement",
            label: "Paiement par prélèvement"},
        {value: "Paiement par espèces",
            label: "Paiement par espèces"},
        {value: "Paiement en paypal",
            label: "Paiement en paypal"},
        {value: "autre moyen de paiement",
    ...
    sujetTicketing: [
        {
            value: "Attestation d'emploi et Certificat de travail",
            label: "Attestation d'emploi et Certificat de travail"
        },
