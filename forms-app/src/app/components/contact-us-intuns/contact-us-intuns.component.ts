...
@Component({
  ...
  templateUrl: './contact-us-intuns.component.html',
  styleUrls: ['./contact-us-intuns.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ContactUsIntunsComponent implements OnInit {
  ...
  onAdd() {
    ...
    if (this.addForm.invalid) {
      ...
      this.LCS.create({ ...this.addForm.value, date_creation: new Date(), custom_id: this.generateID(), source: `Site Web INTUNS`, numero_whatsapp }).subscribe(data => {
          this.addForm.reset()
