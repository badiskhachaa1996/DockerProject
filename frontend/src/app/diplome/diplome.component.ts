...
export class DiplomeComponent implements OnInit {
  ...
  onInitFormAddDiplome() {
    this.formAddDiplome = this.formBuilder.group({
      ...
      campus_id: [this.campusList[0], Validators.required],
