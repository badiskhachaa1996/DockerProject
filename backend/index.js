...
function AuthorizeAccess(req){
    return ((req.headers.origin===undefined || req.headers.origin=="https://ticket.estya.com") && req.header("Sec-Fetch-Site")=="same-origin" && !req.header("User-Agent").contains('Postman')) || req.headers.origin == "http://localhost:4200"
}
